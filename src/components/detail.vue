<template>
  ...
  <div v-else-if="error">something were wrong try again</div>
   ...
   <div class="flex space-x-4 mt-3">
    ...
    <span class="w-40 h-10 rounded-md  bg-cyan-900 hover:bg-black font-sans  text-white px-5 shadow-lg text-2xl"><router-link :to="{name:'Post',params:{slug:$route.params.slug}}"> Post pages</router-link></span>
